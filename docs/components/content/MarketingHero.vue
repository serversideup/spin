<template>
    <div class="mx-auto max-w-[940px] flex flex-col gap-4 md:gap-6 lg:gap-8 px-4 md:px-6 pt-24 md:pt-36 lg:pt-48">
        <h1 class="font-inter text-[28px] md:text-5xl lg:text-[60px] leading-tight md:leading-none text-white font-bold lg:text-center">
            Docker Simplified. Deploy Anywhere. Zero Downtime. Any OS.
        </h1>

        <p class="text-slate-300 font-inter text-base md:text-xl leading-relaxed md:leading-7 lg:text-center">Save thousands. Break free from vendor lock. Replicate your app from development to production. All open source on GitHub.</p>

        <div class="flex flex-col md:flex-row items-center justify-center w-full gap-3 md:gap-0">
            <NuxtLink target="_blank" href="https://github.com/serversideup/spin/" class="rounded-lg bg-white flex w-full md:w-auto items-center justify-center py-3 md:py-4 px-5 md:px-[22px] cursor-pointer text-[#151A1F] font-semibold text-base md:text-lg md:mr-3">
                <svg class="mr-2" width="20" height="20" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <NuxtLink to="/docs" class="rounded-lg w-full md:w-auto justify-center bg-[#1CE783] flex items-center py-3 md:py-4 px-5 md:px-[22px] cursor-pointer text-[#151A1F] font-semibold text-base md:text-lg">
                Get Started &rarr;
            </NuxtLink>
        </div>
    </div>
