        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div ref="menuRef" class="relative">
                    <button type="button" @click="showMenu = !showMenu" class="cursor-pointer flex items-center" style="box-shadow: 0px 20px 24px -4px rgba(16, 24, 40, 0.08), 0px 8px 8px -4px rgba(16, 24, 40, 0.03);">
