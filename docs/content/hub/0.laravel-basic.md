...
| Authors | [Jay Rogers (@jaydrogers)](https://x.com/jaydrogers){target="_blank"}, [Dan Pastori (@danpastori)](https://x.com/danpastori){target="_blank"} |
| License | [GNU GPL v3.0](https://github.com/serversideup/spin-template-laravel-basic/blob/main/LICENSE){target="_blank"} |
...
```bash [Add to an existing Laravel project]
spin init laravel
```
...
[View the project README →](https://github.com/serversideup/spin-template-laravel-basic){target="_blank"}