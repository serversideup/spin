...
| `docker_user.authorized_ssh_keys` | OPTIONAL: Use this only if you're having something like GItHub Actions connect as the Docker User. This must be the **public key** of the your [dedicated SSH keypair that you generated](/docs/guide/generating-a-secure-deployment-key).
