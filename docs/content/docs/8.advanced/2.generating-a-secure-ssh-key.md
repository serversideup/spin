...
1. The [ED25519 encryption](https://ed25519.cr.yp.to/){target="_blank"} algorithm
...
If you want to nerd out on why we suggest this algorithm, you can [read this guide](https://blog.g3rt.nl/upgrade-your-ssh-keys.html){target="_blank"}.
