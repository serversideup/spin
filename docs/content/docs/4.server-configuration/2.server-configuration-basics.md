...
When you run `spin provision`, Spin will pull down [our Ansible Docker image](https://github.com/serversideup/docker-ansible/){target="_blank"} and use the [Spin Ansible Collection](https://github.com/serversideup/ansible-collection-spin){target="_blank"} to configure your providers and servers.
