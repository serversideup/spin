...
```yaml [Example environments configuration in .spin.yml]
##############################################################
# 🌎 Environments
##############################################################
environments:
...
## Advanced Server Configuration
We also give you a few other options to configure your servers that will configure the behavior for the [Spin Ansible Collection](https://github.com/serversideup/ansible-collection-spin){target="_blank"}.

```yaml [.spin.yml Advanced Server Configuration]
##############################################################
# 🤓 Advanced Server Configuration
##############################################################
