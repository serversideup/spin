...
[Sign Up with Vultr →](https://www.vultr.com/?ref=9627777-8H){target="_blank"}
...
To create an API token, you'll need to sign in to the [Vultr Console](https://my.vultr.com/){target="_blank"}. Click on your name in the upper right, then click "API".
...
| `os` | The image to use for the server. | [Vultr Images](https://www.vultr.com/api/#tag/images){target="_blank"} |
| `backups` | Whether to enable snapshot backups for the server (may add 20% to the monthly price). | Learn more about [Vultr snapshot backups](https://docs.vultr.com/vps-automatic-backups){target="_blank"}. |

### Common Region Values
The `region` value is the `id` of the region. You can find the full list of regions using the [Vultr API](https://www.vultr.com/api/#tag/region/operation/list-regions){target="_blank"}.
...
You can find the full list of server types [here](https://www.vultr.com/api/#tag/plans/operation/list-plans){target="_blank"}.

::note
These prices can change at anytime. Be sure to check the latest pricing on the [Vultr Pricing Page](https://www.vultr.com/pricing/){target="_blank"}.
::
