...
[Sign Up with Hetzner →](https://hetzner.cloud/?ref=lhLUIrkdUPhl){target="_blank"}

## Create an API token
To create an API token, you'll need to sign in to the [Hetzner Cloud Console](https://console.hetzner.cloud/){target="_blank"}. Once signed in, select your project.
...
| `image` | The image to use for the server. | [Hetzner Images](https://docs.hetzner.cloud/#images-get-all-images){target="_blank"} |
| `backups` | Whether to enable snapshot backups for the server (may add 20% to the monthly price). | Learn more about [Hetzner snapshot backups](https://docs.hetzner.com/cloud/billing/faq#how-do-you-bill-for-snapshots-and-backups){target="_blank"}. |

### Common Location Values
The `location` value is the `name` of the location. You can find the full list of locations [here](https://docs.hetzner.cloud/#locations-get-all-locations){target="_blank"}.
...
### Common Server Types
::note
Make sure your server type is supported in the location you choose. Also, some of the pricing may change so be sure to check the latest pricing on the [Hetzner Cloud Pricing Page](https://www.hetzner.com/cloud/){target="_blank"}.
::

You can find the full list of server types [here](https://docs.hetzner.cloud/#server-types-get-all-server-types){target="_blank"}.
