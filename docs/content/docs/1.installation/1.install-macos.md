...
[Learn how to install Docker Desktop →](https://docs.docker.com/desktop/mac/install/){target="_blank"}
...
```bash [Install spin to your machine (no root permissions required)]
